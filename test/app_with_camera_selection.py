    ...
    for i in range(10):
        ...
        if cap.isOpened():
            ...
            if i == 0:
                ...
                camera_info['name'] = "Webcam USB / Cámara Externa"
            else:
...
def main():
    ...
    with col1:
        ...
        if 'selected_camera_index' in st.session_state:
            st.info(f"📹 Usando cámara índice: {st.session_state.selected_camera_index}")
